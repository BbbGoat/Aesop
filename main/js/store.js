    ...
    state: {
        ...
        gnb: {
            skin: {
                ...
                subtit: ["제품 모두 보기", "번들", "사랑받는 제품"],
                dd1: ["핸드크림", "바디", "하이드레이터", "토너", "쉐이빙"],
                dd2: ["레버런스 듀엣", "로즈 바디케어 듀엣", "콤팩트 바디 앤 핸드 케어 듀오", "모로칸 네롤리 쉐이빙 듀엣"],
                dd3: ["레버런스 아로마틱 핸드 밤", "만다린 페이셜 하이드레이팅 크림", "비터 오렌지 아스트린젠트 토너", "레졸루트 하이드레이팅 바디 밤"],
            ...
            perfume: {
                ...
                subtit: ["제품 모두 보기", "페어링", "신제품"],
                dd1: ["플로럴", "프레쉬", "우디", "오퓰런트"],
                dd2: ["로즈 앙상블", "테싯 앙상블", "휠 앙상블", "마라케시 인텐스 앙상블","이더시스 오 드 퍼퓸"],
                dd3: [
                    "글롬 오 드 퍼퓸",
                ],
            ...
            home: {
                ...
                dd1: ["인센스", "캔들", "룸스프레이", "문학"],
                dd2: ["존재의 상태: 아로마틱 룸 스프레이 트리오", "브론즈 인센스 홀더", "이솝:홈 프래그런스", "브라스 오일 버너"],
                dd3: ["칼리푸스 아로마틱 캔들", "올루스 아로마틱 룸 스프레이", "사라시나 아로마틱 인센스"],
            ...
            gift: {
                ...
                subtit: ["제품 모두 보기", "시즈널", "사랑받는 제품"],
                dd1: ["시즈널 기프트 키트", "스킨 케어 키트", "바디&핸드 케어 키트", "트래블"],
                dd2: ["인더스트리어스", "이그니어스", "콘그루어스", "프리시피터스"],
                dd3: ["어라이벌", "시더 & 시트러스 립 살브", "젠틀 딥 클렌징 듀오"],
